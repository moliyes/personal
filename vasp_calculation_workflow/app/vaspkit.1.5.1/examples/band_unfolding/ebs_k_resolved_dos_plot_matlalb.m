...
ylim([-6 4]);
set(gca,'ytick',-6:2:4)
set(gca, 'XTickLabel', {'\Gamma', 'M', 'K', '\Gamma'}, 'XTick', [momentum_min 1.137 1.793 momentum_max],'Fontsize',20)  % '\Gamma', 'M', 'K', '\Gamma', 1.137 and 1.793 is read from KLABEL file
line([momentum_min momentum_max], [0 0], 'LineStyle', '--', 'Color', 'w', 'LineWidth',1)                                
line([1 1]*1.137, [energy_min energy_max], 'LineStyle', '--', 'Color', 'w', 'LineWidth',1)                              % 1.137 is read from KLABEL file
line([1 1]* 1.793, [energy_min energy_max], 'LineStyle', '--', 'Color', 'w', 'LineWidth',1)                             % 1.793 is read from KLABEL file
