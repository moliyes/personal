...
light;
lighting flat;
h=colorbar('position',[0.723,0.342,0.046,0.351])
t=get(h,'Limits');
...
hold on
set(gca,'Fontsize',30) 
mArrow3([0 0 0],[1.3*max(R) 0 0],'color','red','stemWidth',0.5,'facealpha',0.5);
mArrow3([0 0 0],[0 1.3*max(R) 0],'color','green','stemWidth',0.5);
mArrow3([0 0 0],[0 0 1.3*max(R)],'color','blue','stemWidth',0.5);
text(1.3*max(R),0,0,'x','FontSize',35)
text(0,1.3*max(R),0,'y','FontSize',35)
text(0,0,1.3*max(R),'z','FontSize',35)
